...
/**
 * format_eabctiles cache definitions.
 * @see \format_eabctiles\local\modal_helper::get_modal_allowed_cm_ids()
 * @see \format_eabctiles\observer::clear_cache_modal_cmids()
 *
...
$definitions = [
    ...
    'modalcmids' => [
        ...
        'invalidationevents' => [
            'format_eabctiles/modaladminsettingchanged',
        ],
    ],
