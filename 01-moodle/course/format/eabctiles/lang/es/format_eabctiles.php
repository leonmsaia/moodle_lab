...
$string['addsections'] = 'Agregar ficha';
...
$string['dataprefquestion'] = '<p>Para que este sitio sea más fácil de usar, almacenamos información funcional en tu navegador, como el número de identificación de la última ficha que abriste. Esto permanece en tu dispositivo por un corto tiempo en caso de que vuelvas a visitar esa página. No lo usamos para rastreo. ¿Está bien?</p><p>Recordaremos tu elección hasta que borres el historial de navegación. Para rechazar, haz clic en "Cancelar".</p>';
...
$string['pluginname'] = 'Eabctiles';
$string['previoustopic'] = 'Previous topic';
$string['privacy:metadata:preference:format_eabctiles_high_contrast_mode'] = 'Whether the user is using high contrast mode.';
$string['privacy:metadata:preference:format_eabctiles_stopjsnav'] = 'Whether the user has disabled animated JavaScript navigation.';
...
$string['settings'] = 'eabctiles format settings';
$string['show'] = 'Show';
...
$string['tilecolourschanged'] = 'eabctiles colours have been reset.  All tiles now have colours conforming to the colours below.';
...
$string['eabctilesformatregistration'] = 'eabctiles format registration';
$string['eabctilesreset'] = 'eabctiles & icons have been reset for this course';
$string['eabctilestyle'] = 'Tile Style';
$string['eabctilestyle_desc'] = 'Style 1 = photo tiles will show the title at the top of the tile, style 2 = title at the bottom';
...
$string['closeactivity'] = 'Finalizar actividad';
$string['open'] = 'Abrir';
$string['close'] = 'Finalizar';
$string['noaccess'] = 'Usted no tiene acceso a esta pagina';
$string['suspendactivity'] = 'Suspender actividad';
$string['confirmsuspendactivity'] = 'Confirmar que desea suspender la actividad para este grupo';
$string["errormsg"] = '{$a}';
$string["eabctiles:closegroup"] = 'Finalizar o suspender grupo';
$string["rut"] = 'Rut';
$string["closeandsuspend"] = 'Finalizar o suspender';
$string["listreasonsuspend"] = 'Lista de motivos de suspensión';
$string["listreasonsuspend_help"] = 'Lista de motivos de suspensión separados por coma(,)';
$string["eabctiles:closenavenrolandgrades"] = 'Quitar del nav matriculaciones y calificador';
$string["closeactivities"] = 'Finalizar actividad';
$string["suspend"] = 'Suspender';
$string["response"] = 'Respuesta:';
$string["cause"] = 'Causa:';
$string["listreasonsuspendopen"] = 'Lista de motivos de suspensión preguntas abiertas';
$string["endorsuspendactivity"] = 'Finalizar o Suspender Actividad';
$string["notaccessactivityclose"] = 'Página no disponible por que la actividad esta cerrada.';
$string["blockbuttonsuspend"] = 'Opción bloqueada por que la actividad esta cerrado.';
$string["cancel"] = 'Cancelar';
$string["confirm"] = 'Confirmar';
$string["finalize"] = 'Finalizar';
$string["msgalertclose"] = 'La actividad será cerrada. No se podrá ingresar notas y asistencias. Desea continuar?';
$string["msgalertopen"] = 'La actividad será aperturada. Desea continuar?';
$string["duration"] = 'Duración (Días)';
$string["sessionuser"] = 'Sesiones del usuario';
$string["finicio"] = 'Fecha inicio';
$string["durationses"] = 'Duración (min)';
$string["status"] = 'Estatus';
$string["cursosuspend"] = ' Curso suspendido';
$string["finalizado"] = 'Finalizado';
$string["finalizadotext"] = 'Curso Finalizado, no posee permisos para abrir nuevamente';
$string['urlsminarioweb'] = 'Link a la videoconferencia';
$string["eabctiles:button_open_group"] = 'Abrir group';
