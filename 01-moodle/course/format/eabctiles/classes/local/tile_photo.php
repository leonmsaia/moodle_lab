...
class tile_photo {
    ...
    /**
     * Get the element id for this object as used in the format_eabctiles_tile_options table.
    ...
    public function verify_aspect_ratio() {
        ...
        $messageshort = get_string('imagesize', 'format_eabctiles') . ": ";
        if (abs($ratio - $requiredratio) > $tolerance) {
            if ($ratio > $requiredratio) {
                $tallorwide = ['tallorwide' => get_string('tootall', 'format_eabctiles')];
                $messageshort .= get_string('tootall', 'format_eabctiles');
            } else {
                $tallorwide = ['tallorwide' => get_string('toowide', 'format_eabctiles')];
                $messageshort .= get_string('toowide', 'format_eabctiles');
            }
            return [
                'status' => false,
                'message' => get_string(
        ...
        $messageshort .= get_string('ok', 'format_eabctiles');
