...
/**
 * Helper class for dealing with modals class for format_eabctiles.
...
class modal_helper {
    ...
    public static function allowed_modal_modules(): array {
        ...
        if ($devicetype != \core_useragent::DEVICETYPE_TABLET && $devicetype != \core_useragent::DEVICETYPE_MOBILE
            ...
            $resources = get_config('format_eabctiles', 'modalresources');
            $modules = get_config('format_eabctiles', 'modalmodules');
            return [
    ...
    public static function get_modal_allowed_cm_ids(int $courseid, bool $excludeunavailable): object {
        ...
        $cache = \cache::make('format_eabctiles', 'modalcmids');
    ...
    public static function clear_cache_modal_cmids(int $courseid, string $modulename = ''): bool {
        // See also \cache_helper::purge_by_event('format_eabctiles/modaladminsettingchanged') in settings.php.
        $cache = \cache::make('format_eabctiles', 'modalcmids');
        switch ($modulename) {
            case 'resource':
