...
namespace format_eabctiles\output\courseformat\content;
...
class section extends section_base {
    ...
    public function export_for_template(\renderer_base $output): \stdClass {
        ...
        if (!$data->hasphoto) {
            $data->tileicon = \format_eabctiles\local\format_option::get(
                $this->section->course, \format_eabctiles\local\format_option::OPTION_SECTION_ICON, $this->section->id
            );
            if (!$data->tileicon) {
        ...
        $data->tilestyle = get_config('format_eabctiles', 'eabctilestyle') ?? 1;
