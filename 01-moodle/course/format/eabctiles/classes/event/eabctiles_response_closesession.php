...
class eabctiles_response_closesession extends \core\event\base {
    ...
    public static function get_name() {
        return "Response ws cerrar por sesión";
    }
    ...
    public function get_description() {
        $message = "Response ws cerrar sesión";
        ...
        if(!empty($this->other["groupid"])){
            $message .= 'groupid: ' . $this->other["response"];
            $message .= \html_writer::empty_tag('br');
        }
