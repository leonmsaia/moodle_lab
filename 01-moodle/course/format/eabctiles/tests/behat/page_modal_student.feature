@format @format_eabctiles @format_eabctiles_mod_modal  @format_eabctiles_page_modal_student @javascript
Feature: Student can open a page
  ...
  Scenario: Open page using modal as student with subtiles on
    When format_eabctiles subtiles are on for course "Course 5"
  ...
  Scenario: Open page using modal as student - with subtiles off
    When format_eabctiles subtiles are off for course "Course 5"
    And I log in as "student1"
    And I am on "Course 5" course homepage
    And I click on tile "6"
    And I wait until the page is ready
