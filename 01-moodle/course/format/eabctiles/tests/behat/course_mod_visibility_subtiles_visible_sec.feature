@format @format_eabctiles @format_eabctiles_course_mod_visibility_subtiles_visible_sec  @javascript
Feature: Teacher can hide course modules when subtiles being used in a visible section and this is respected
  ...
  Background:
    ...
    And format_eabctiles subtiles are on for course "Course Mod Vis Course4"
