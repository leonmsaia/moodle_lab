@format @format_eabctiles @format_eabctiles_mod_modal @format_eabctiles_pdf_modal_student  @javascript @_file_upload
Feature: PDFs can be set to open in modal windows
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | resource | Test PDF       | File description      | C1-pdf | pdf1     | 1       | 1       | 1          | course/format/eabctiles/tests/fixtures/test.pdf | 1        |
  ...
  Scenario: Open modal PDF as student with subtiles off
    When format_eabctiles subtiles are off for course "Course 1"
  ...
  Scenario: Open modal PDF as student with subtiles on
    When format_eabctiles subtiles are on for course "Course 1"
    And I log in as "student1"
    And I am on "Course 1" course homepage
    And I wait until the page is ready
    And I click on tile "1"
