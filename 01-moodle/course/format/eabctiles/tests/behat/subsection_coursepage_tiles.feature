@format2 @format_eabctiles @format_eabctiles_subsection
Feature: Users view subsections on course page in tiles format
  ...
  Background:
    ...
    And the following "courses" exist:
      | fullname | shortname    | category  | numsections   | initsections  | format |
      | Course 1 | C1           | 0         | 3             | 1             | tiles  |
    ...
    And the following "activities" exist:
      ...
      | page       | Page2 in Subsection2   | C1        | page12   | 5       |
      | data       | New database           | C1        | data1    | 3       |
      | page       | New page               | C1        | page1    | 3       |

  @javascript
  Scenario: Student can view, expand and collapse subsections on course page with subtiles on
    ...
    And I should not see "Page1 in Subsection1" in the "Subsection1" "activity"
    And I click on "Expand" "link" in the "Subsection2" "activity"
  ...
  @javascript
  Scenario: Student can view, expand and collapse subsections on course page with subtiles off
    When I log in as "student1"
    And I am on "Course 1" course homepage
  ...
  @javascript
  Scenario: Teacher can create activities inside subsections on course page in tiles format
  ...
  @javascript
  Scenario: Teacher can create activities between subsections on course page in tiles format
    When I log in as "teacher1"
    And I am on "Course 1" course homepage with editing mode on
  ...
  @javascript
  Scenario: Teacher can create a subsection at section bottom in tiles format
    When I log in as "teacher1"
    And I am on "Course 1" course homepage with editing mode on
  ...
  @javascript
  Scenario: Teacher can create a subsection between activities in tiles format
    When I log in as "teacher1"
    And I am on "Course 1" course homepage with editing mode on
  ...
  @javascript
  Scenario: Teacher can create an activity at section bottom in tiles format
    When I log in as "teacher1"
    And I am on "Course 1" course homepage with editing mode on
    And I click on "Add content" "button" in the "General" "section"
    And I wait "1" seconds
  ...
  @javascript
  Scenario: Teacher can create an activity between activities in tiles format
    When I log in as "teacher1"
    And I am on "Course 1" course homepage with editing mode on
    And I hover "Insert content before 'New page'" "button"
    And I wait "1" seconds
