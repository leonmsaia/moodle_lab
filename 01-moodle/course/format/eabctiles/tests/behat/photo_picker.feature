@format @format_eabctiles @format_eabctiles_photo_picker @javascript @_file_upload
Feature: Teacher can allocate photos to tiles
  ...
  Background:
    ...
    And the following config values are set as admin:
      ...
      | allowphototiles        | 1        | format_eabctiles |
  ...
  Scenario: Teacher can use photo picker to pick photos (and icons), can backup and restore course, and student can view
    ...
    And I upload "course/format/eabctiles/tests/fixtures/images/placeholder_1.jpg" file to "Upload new photo" filemanager
    ...
    And "Pick a new icon or background photo" "dialogue" should be visible
    And I follow "Upload new photo"
    And I upload "course/format/eabctiles/tests/fixtures/images/placeholder_3.jpg" file to "Upload new photo" filemanager
    And I press "Save changes"
    And I wait until the page is ready
