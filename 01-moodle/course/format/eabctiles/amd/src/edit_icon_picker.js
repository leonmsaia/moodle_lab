...
/**
 * Javascript Module to handle the icon picker dialogue for format_eabctiles
 * which the editing user uses to select an icon for a tile or the default icon
 * for all tiles in the course
 *
 * @module      format_eabctiles/icon_picker
    ...
    function ($, Templates, ajax, str, Notification, config) {
        ...
        var getAndStoreIconSet = function(courseId, callback) {
            var photosPromises = ajax.call([{
                methodname: "format_eabctiles_get_icon_set",
        ...
        var getPhotoTileButtonUrl = function(courseId, sectionId) {
            return config.wwwroot
                + '/course/format/eabctiles/editor/editimage.php?sectionid=' + sectionId;
        };
        ...
        var setIcon = function (
            ...
            var changeUiTilePhoto = function (jqueryObjToChange, imageUrl, imageType) {
                ...
                switch (imageType) {
                    ...
                    case 'tilephoto':
                        if (!imageUrl) {
                            // Unsetting photo.
                            templateParams.tileicon = $('#format-eabctiles-js-config').data('defaultcourseicon');
                            templateToRender = 'tileicon';
                            break;
                        }
                ...
                divToAnimate.animate({opacity: 0}, 500, function () {
                    Templates.render("format_eabctiles/" + templateToRender, templateParams)
                        .done(function (html) {
            ...
            var setIconDbPromises = ajax.call([{
                methodname: "format_eabctiles_set_image",
                ...
                if (response.status === true) {
                    if (onCoursePage) {
                        ...
                        if (imageType === "tileicon") {
                            Templates.renderPix("tileicon/" + icon, "format_eabctiles", displayname)
        ...
        var launchIconPicker = function (pageType, courseId, sectionId, section,
            ...
            if (typeof modalStored !== "object") {
                ...
                var renderModal = function() {
                    Templates.render("format_eabctiles/icon_picker_modal_body", {
                        ...
                        require(["core/modal_factory"], function (modalFact) {
                            modalFact.create({
                                ...
                                if (allowPhotoTiles) {
                                    ...
                                    $("#launch-photo-library").click(function () {
                                        if (recentPhotoSet.length !== 0) {
                                            Templates.render("format_eabctiles/icon_picker_photos", {
                                                /* eslint-disable-next-line camelcase */
                                ...
                                $(document).trigger('format-eabctiles-icon-picker-modal-created');
                            });
                        });
                    });
                };
        ...
        return {
            init: function (courseId, pageType, allowPhotoTiles, documentationurl, maxNumberIcons) {
                $(document).ready(function () {
                    ...
                    str.get_string(stringKey, "format_eabctiles").done(function (pickAnIcon) {
