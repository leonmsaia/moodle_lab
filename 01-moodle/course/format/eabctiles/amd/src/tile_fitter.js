 ...
 *
 * @module format_eabctiles/tile_fitter
...
define(["jquery", "core/ajax"], function ($, ajax) {
    ...
    var Selector = {
        ...
        TILES_OUTER: ".format-eabctiles.jsenabled #format-eabctiles-multi-section-page",
        TILES: ".format-eabctiles.jsenabled ul.tiles",
        ACTIVITY: ".activity",
        SPACER: ".spacer",
        SECTION_ID: "#section-",
     ...
     * @see \format_eabctiles\local\util::width_template_data() for more information.
     * @return {Promise}
     */
    var resizeTilesDivWidth = function() {
        ...
        try {
            ...
            timeoutBeforeResizeAjax = setTimeout(function () {
                ...
                ajax.call([{
                    methodname: "format_eabctiles_set_session_width",
