...
/**
 * Main Javascript module for format_eabctiles for when user is *NOT* editing.
 ...
 *
 * @module      format_eabctiles/course
 * @copyright   2018 David Watson {@link http://evolutioncode.uk}
 * @license     http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

define(["jquery", "core/templates", "core/ajax", "format_eabctiles/browser_storage",
        "core/notification", "core/str", "format_eabctiles/tile_fitter", 'core/fragment'],
    function ($, Templates, ajax, browserStorage, Notification, str, tileFitter, Fragment) {
        ...
        var ClassNames = {
            ...
            HAS_OPEN_TILE: 'format-eabctiles-tile-open',
        ...
        const OVERLAY_ID = 'format_eabctiles_overlay';
        ...
        var setCourseContentHTML = function (contentArea, html, js) {
            ...
            $(document).trigger('format-eabctiles-section-content-changed', {
            ...
            var expandAndScroll = function () {
                ...
                if (iframes.length > 0) {
                    ...
                    if (enableCompletion) {
                        ...
                        setTimeout(() => {
                            $(document).trigger('format-eabctiles-completion-changed', {
                                courseid: courseId,
        ...
        var getSectionContentFromServer = function (courseContextId, sectionId) {
            ...
            // This gets the fragment from format_eabctiles_output_fragment_get_cm_list().
            return Fragment.loadFragment(
                'format_eabctiles', 'get_cm_list', courseContextId, {sectionid: sectionId}
            );
        };
        ...
        var populateAndExpandSection = function(courseContextId, sectionId, sectionNumber) {
            ...
            ajax.call([{
                methodname: "format_eabctiles_log_tile_click", args: {
            ...
            init: function (
                ...
                $(document).ready(function () {
                    ...
                    if (useSubTiles) {
                        ...
                        $(Selector.BODY).addClass('format-eabctiles-subtiles');
                    }
                    ...
                    if (anchorMatches && anchorMatches.length) {
                        ...
                        if (anchorCmId) {
                            ...
                            openTile = null;
                            ajax.call([{
                                methodname: "format_eabctiles_get_course_mod_info", args: {cmid: anchorCmId}
                    ...
                    $(document).on('format-eabctiles-completion-changed', function(e, data) {
                        ...
                        ajax.call([
                            {
                                methodname: "format_eabctiles_get_section_information",
                                args: {
                                    courseid: courseId,
                        ...
                        .done((response) => {
                            require(["format_eabctiles/completion"], function (completion) {
                    ...
                    if (useFilterButtons) {
                        require(["format_eabctiles/filter_buttons"], function (filterButtons) {
                    ...
                    Templates.render("format_eabctiles/loading", {}).done(function (html) {
                    ...
                    var stringKeys = [
                        {key: "sectionerrortitle", component: "format_eabctiles"},
                        {key: "refresh"},
                        {key: "cancel", component: "moodle"},
                        {key: "noconnectionerror", component: "format_eabctiles"},
                        {key: "show"},
                        {key: "hide"},
                        {key: "other", component: "format_eabctiles"},
                        {key: "continue"}
                    ];
