 ...
 *
 * @module      format_eabctiles/course_mod_modal
            ...
            modalFactory.create({
                ...
                if (objectType === 'page') {
                    ...
                    Fragment.loadFragment(
                        'format_eabctiles', `get_cm_content`, moduleContextId, {contextid: moduleContextId}
                    )
                    ...
                    if (objectType === "html") {
                        ...
                        template = 'format_eabctiles/embed_file_modal_body';
                        ...
                        template = 'format_eabctiles/embed_url_modal_body';
                    }
                ...
                Templates.render("format_eabctiles/embed_module_modal_header_btns", headerTemplateData).done(function (html) {
        ...
        return {
            init: function (courseIdInit, isEditing, pageType, launchModalCmid, usingJsNav) {
                ...
                $(document).ready(function () {
                    tilesConfig = $('#format-eabctiles-js-config').data();
                    ...
                    if (['course-view-tiles', 'section-view-tiles', 'course-view-section-tiles'].includes(pageType)) {
                            ...
                            courseIndex.on('click', function(e) {
                                ...
                                if (link && link.data('for') === 'cm_name') {
                                    ...
                                    if (linkUrl) {
                                        ...
                                        ajax.call([{
                                            methodname: "format_eabctiles_get_course_mod_info", args: {cmid: cmId}
                                            ...
                                            if (modalRequired(cmId, linkUrl)) {
                                                ...
                                                if (usingJsNav) {
                                                    if (expandedSection.length === 0) {
                                                        require(["format_eabctiles/course"], function (course) {
                        ...
                        if (launchModalCmid) {
                            ajax.call([{
                                methodname: "format_eabctiles_get_course_mod_info", args: {cmid: launchModalCmid}
                            }])[0].done(function (data) {
                        ...
                        Templates.render("format_eabctiles/loading", {})
