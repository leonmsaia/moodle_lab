...
// This will take us to render_content() in /course/format/eabctiles/classes/output/renderer.php.
$outputclass = $format->get_output_classname('content');
$widget = new $outputclass($format);
echo $renderer->render($widget);

// Include format.js (required for dragging sections around).
$PAGE->requires->js('/course/format/eabctiles/format.js');

// Other JS initialisation has been moved to render_content() in /course/format/eabctiles/classes/output/renderer.php.
