...
// Url of current page.
$baseurl = new moodle_url('/admin/tool/eabcetlbridge/pages/test_sync_user_data.php');
...
use tool_eabcetlbridge\external\sync_user_data;

$result = sync_user_data::execute(
    required_param('username', PARAM_RAW),
    optional_param_array('migrations', [], PARAM_RAW),
    //optional_param_array('options', [], PARAM_RAW)
);
