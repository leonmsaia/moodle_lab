...
$result = sync_user_grades::execute(
    required_param('username', PARAM_RAW),
    optional_param('courseshortname', null, PARAM_RAW),
    optional_param('groupname', null, PARAM_RAW),
    optional_param('source', 'local', PARAM_ALPHA),
    optional_param('forceregrade', false, PARAM_BOOL),
    optional_param('fullregrade', false, PARAM_BOOL),
    optional_param('forceoverride', false, PARAM_BOOL)
);
