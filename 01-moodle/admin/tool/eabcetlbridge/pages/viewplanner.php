...
use tool_eabcetlbridge\reportbuilder\local\systemreports\planner_report as persistentreport;
...
// Variables.
global $PAGE, $OUTPUT;
$pageurl = url::viewbatch_files();
$pagetitle = 'Listado de Elementos Planificados';
...
$report->set_filter_values([
    'adhoc_task:component_operator' => \core_reportbuilder\local\filters\text::IS_EQUAL_TO,
    'adhoc_task:component_value' => "tool_eabcetlbridge",
]);
