...
use tool_eabcetlbridge\reportbuilder\local\entities\batch_file as mainentity;
use tool_eabcetlbridge\persistents\batch_files as persistent;
use tool_eabcetlbridge\url;

/**
 * Batch Files system report class implementation
 *
 ...
 */
class batch_files_report extends system_report {
    ...
    protected function initialise(): void {
        ...
        $this->add_base_fields("{$entitymainalias}.id, {$entitymainalias}.logid");
        ...
        $this->set_downloadable(true, get_string('entity_batch_file', 'tool_eabcetlbridge'));
    }
    ...
    public function add_columns(): void {
        $columns = [
            ...
            'batch_file:type',
            'batch_file:qtylines',
            'batch_file:qtyrecords',
            'batch_file:qtyrecordsprocessed',
            'batch_file:usermodified',
            'batch_file:timemodified',
            'batch_file:courseid',
            'batch_file:status',
        ];
