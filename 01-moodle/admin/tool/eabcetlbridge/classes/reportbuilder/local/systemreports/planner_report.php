...
use tool_eabcetlbridge\reportbuilder\local\entities\planner as mainentity;
use tool_eabcetlbridge\persistents\planners\planner as persistent;
use tool_eabcetlbridge\url;

/**
 * Planner system report class implementation
 *
 ...
 */
class planner_report extends system_report {
    ...
    protected function initialise(): void {
        ...
        $this->add_base_fields(
            "{$entitymainalias}.id,{$entitymainalias}.batchfileid,{$entitymainalias}.configid," .
            "{$entitymainalias}.courseid,{$entitymainalias}.itemidentifier");
        ...
        $this->set_downloadable(true, get_string('entity_planner', 'tool_eabcetlbridge'));
    }
    ...
    public function add_columns(): void {
        $columns = [
            ...
            'planner:type',
            'planner:objective',
            'planner:itemidentifier',
            'planner:courseid',
            'planner:batchfileid',
            'planner:configid',
            'planner:timemodified',
            'planner:status',
        ];
    ...
    protected function add_actions(): void {
        ...
        $this->add_action((new action(
            new url('/grade/report/grader/index.php', ['id' => ':courseid']),
            new pix_icon('t/edit', '', 'core'),
            [],
            false,
        ...
        $this->add_action((new action(
            new url(url::editbatch_files(), ['id' => ':batchfileid']),
            new pix_icon('t/edit', '', 'core'),
            [],
            false,
