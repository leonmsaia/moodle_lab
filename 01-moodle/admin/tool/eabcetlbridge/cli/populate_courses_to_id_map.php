...
/**
 * CLI script to populate courses to eabcetlbridge_id_map table.
 *
...
if ($unrecognized || $options['help']) {
    $help = <<<EOT
Carga los cursos en la tabla eabcetlbridge_id_map

Options:
-h, --help            Imprime esta ayuda

Example:
\$ sudo -u www-data php admin/tool/eabcetlbridge/cli/populate_courses_to_id_map.php
EOT;
    echo $help;
    die;
}
...
// User Mapping.
cli_writeln('Consultando cursos que no esten en la tabla eabcetlbridge_id_map...');
$table = 'course';
$sourcetype = 'course';
$sourcekey = 'shortname';
$targetid = 'id';
