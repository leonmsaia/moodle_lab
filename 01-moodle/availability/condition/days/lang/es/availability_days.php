...
$string['full_days'] = 'Disponible hasta el día <strong>{$a}</strong> a partir de la fecha de inscripción del curso';
$string['short_days'] = 'Disponible hasta el día <strong>{$a}</strong>';
$string['title'] = 'Days';
