...
export default class AccessibilityModal extends Modal {
    static TYPE = "theme_mutualseguridad/themesettings_modal";
    static TEMPLATE = "theme_mutualseguridad/accessibilitysettings_modal";

    constructor(root) {
        super(root);

        let request = Ajax.call([{
            methodname: 'theme_mutualseguridad_getthemesettings',
            args: {}
        }]);
    ...
    registerEventListeners() {
        ...
        this.getModal().on(CustomEvents.events.activate, '[data-action="save"]', function() {
            let request = Ajax.call([{
                methodname: 'theme_mutualseguridad_savethemesettings',
                args: {
