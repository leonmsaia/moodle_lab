...
namespace theme_mutualseguridad\api;
...
class accessibility extends external_api {
    ...
    public static function savethemesettings($formdata) {
        ...
        if ($data['fonttype'] && in_array($data['fonttype'], ['default', 'odafont'])) {
            ...
            set_user_preference('thememutualseguridadsettings_fonttype', $fonttype);
        }
        ...
        set_user_preference('thememutualseguridadsettings_enableaccessibilitytoolbar', $enableaccessibilitytoolbar);

        \core\notification::success(get_string('themesettingg:successfullysaved', 'theme_mutualseguridad'));
    ...
    public static function getthemesettings() {
        return [
            'fonttype' => get_user_preferences('thememutualseguridadsettings_fonttype', 'default'),
            'enableaccessibilitytoolbar' => get_user_preferences('thememutualseguridadsettings_enableaccessibilitytoolbar', false),
        ];
    }
