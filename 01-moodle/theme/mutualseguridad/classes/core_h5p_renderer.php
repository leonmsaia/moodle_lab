...
/**
 * Class theme_mutualseguridad_core_h5p_renderer.
 *
 ...
 */
class theme_mutualseguridad_core_h5p_renderer extends \core_h5p\output\renderer {
    /**
    ...
    public function h5p_alter_styles(&$styles, array $libraries, string $embedtype) {
        $theme = \theme_config::load('mutualseguridad');
    ...
    protected function get_style_url($content) {
        ...
        return \moodle_url::make_file_url("$CFG->wwwroot/pluginfile.php",
            "/$syscontext->id/theme_mutualseguridad/hvp/$itemid/themehvp.css");
    }
}
