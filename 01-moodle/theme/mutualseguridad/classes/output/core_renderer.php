...
use moodle_url;
use html_writer;
use theme_mutualseguridad\output\core_course\activity_navigation;

include_once($CFG->dirroot . '/local/eabcourses/locallib.php');
...
class core_renderer extends \theme_boost\output\core_renderer {
    ...
    public function body_attributes($additionalclasses = []) {
        $hasaccessibilitybar = get_user_preferences('thememutualseguridadsettings_enableaccessibilitytoolbar', '');
        ...
        $fonttype = get_user_preferences('thememutualseguridadsettings_fonttype', '');
        if ($fonttype) {
    ...
    public function render_login(\core_auth\output\login $form) {
        ...
        return $this->render_from_template('theme_mutualseguridad/loginform', $context);
    }
    ...
    public function get_navbar_callbacks_data() {
        $callbacks = get_plugins_with_function('mutualseguridad_additional_header', 'lib.php', true, true);
    ...
    public function get_module_footer_callbacks_data() {
        $callbacks = get_plugins_with_function('mutualseguridad_module_footer', 'lib.php', true, true);
    ...
    public function redirect_message($encodedurl, $message, $delay, $debugdisableredirect,
        ...
        $output .= $this->render_from_template('theme_mutualseguridad/loading-overlay', ['encodedurl' => $encodedurl]);
    ...
    public function navbar(): string {
        $newnav = new \theme_mutualseguridad\output\boostnavbar($this->page);
