...
namespace theme_mutualseguridad\privacy;
...
class provider implements
    ...
    const FONTTYPE = 'thememutualseguridadsettings_fonttype';
    /** The user preference for the enable accessibility toolbar. */
    const TOOLBAR = 'thememutualseguridadsettings_enableaccessibilitytoolbar';
    ...
    public static function get_metadata(collection $items): collection {
        ...
        $items->add_user_preference(self::FONTTYPE, 'privacy:metadata:preference:thememutualseguridadsettings_fonttype');
        $items->add_user_preference(self::TOOLBAR, 'privacy:metadata:preference:thememutualseguridadsettings_enableaccessibilitytoolbar');
        return $items;
    }
    ...
    public static function export_user_preferences(int $userid) {
        ...
        if (isset($toolbar)) {
            writer::export_user_preference(
                'theme_mutualseguridad',
                self::TOOLBAR,
                $toolbar,
                get_string('privacy:thememutualseguridadsettings_enableaccessibilitytoolbar', 'theme_mutualseguridad', $toolbar)
            );
            ...
            if (isset($fontsize)) {
                writer::export_user_preference(
                    ...
                    self::FONTSIZE,
                    $fontsize,
                    get_string('privacy:accessibilitystyles_fontsizeclass', 'theme_mutualseguridad', $fontsize)
                );
            }
            ...
            if (isset($sitecolor)) {
                writer::export_user_preference(
                    ...
                    self::SITECOLOR,
                    $sitecolor,
                    get_string('privacy:accessibilitystyles_sitecolorclass', 'theme_mutualseguridad', $sitecolor)
                );
            }
        }
        ...
        if (isset($fonttype)) {
            writer::export_user_preference(
                ...
                self::FONTTYPE,
                $fonttype,
                get_string('privacy:thememutualseguridadsettings_fonttype', 'theme_mutualseguridad', $fonttype)
            );
        }
    }
}
