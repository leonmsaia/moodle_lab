...
if ($options['help']) {
    ...
    Example:
    php local/pubsub/cli/aprobados_elearning_x_cursos_id.php --lote=1 --t=15 --c=82500 --minid=1001 --maxid=391234
    ";
    exit(0);
}
...
WHERE ieb.timereported = 0 
  ...
  AND ieb.id_curso_moodle in (927, 939, 992)
...
echo "\n Fin de la ejecución APROBADOS X CURSOS. Procesados: ".$procesados. " de un total de: ".count($enrollments)."\n\n";