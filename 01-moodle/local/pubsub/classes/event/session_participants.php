 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class session_participants extends \core\event\base {
    /**
     * Init method.
     */
    ...
    public static function get_name() {
        return "participantes de las sesiones";
    }
    ...
    public function get_description() {
        $message = "Participantes de las sesiones";
        ...
        if(!empty($this->other["guid"])){
            $message .= 'guid: ' . $this->other["guid"];
            $message .= \html_writer::empty_tag('br');
        }
        return $message;
    }
