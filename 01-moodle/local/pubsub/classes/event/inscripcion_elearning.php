 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class inscripcion_elearning extends \core\event\base {
    /**
     * Init method.
     */
    ...
    public static function get_name() {
        return "Inscripcion participante Elearning";
    }
    ...
    public function get_description() {
        $message = "Participante en curso elearning";
        ...
        if(!empty($this->other["ParticipanteProductId"])){
            $message .= 'ParticipanteProductId: ' . $this->other["ParticipanteProductId"];
            $message .= \html_writer::empty_tag('br');
        }
        return $message;
    }
