 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class MoodleQuickForm_autocomplete2 extends MoodleQuickForm_select {
     ...
     */
    public function MoodleQuickForm_autocomplete2($elementName=null, $elementLabel=null, $options=null, $attributes=null) {
    ...
    function toHtml(){
        ...
        if (!$this->isFrozen()) {
            $PAGE->requires->js_call_amd('local_rating_item/form-autocomplete', 'enhance', $params = array('#' . $id, $this->tags, $this->ajax,
