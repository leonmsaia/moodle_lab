 ...
 */
class elsa_consolidado_v1 extends system_report {
    ...
    protected function initialise(): void {
        ...
        if ($applyfilter) {
            ...
            $hour = isset($config->migration_hour) ? (int)$config->migration_hour : 23;
            $minute = isset($config->migration_minute) ? (int)$config->migration_minute : 59;
            $second = isset($config->migration_second) ? (int)$config->migration_second : 59;
