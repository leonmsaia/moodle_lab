 ...
 */
class elsa_with_external_db35 extends system_report {
    ...
    protected function initialise(): void {
        ...
        $downloadname = get_string('download_report_elsa35', 'local_mutualreport').'_'.time();
    ...
    public function add_columns(): void {
        $columns = [
            ...
            'company:rut',
            'company:contrato',
            'user:profilefield_contactonombres',
            'user:profilefield_contactoapellidopaterno',
            'user:profilefield_contactoemail',
            'user:profilefield_cintactoiddoc',
        ];
        $this->add_columns_from_entities($columns);

        // Change names for columns.
        $this->get_column('enrolment:timecreated')->set_title(new lang_string('enroleddate', 'local_mutualreport'));
        $this->get_column('user:username')->set_title(new lang_string('field_rut', 'local_mutualreport'));
        $this->get_column('user:lastaccess')->set_title(new lang_string('sitelastaccess', 'local_mutualreport'));
        $this->get_column('user:profilefield_contactonombres')->set_title(new lang_string(
            'managername', 'local_mutualreport'
        ));
        $this->get_column('user:profilefield_contactoapellidopaterno')->set_title(
            new lang_string('managerlastname', 'local_mutualreport'
        ));
        $this->get_column('user:profilefield_contactoemail')->set_title(new lang_string('managermail', 'local_mutualreport'));
        $this->get_column('user:profilefield_cintactoiddoc')->set_title(new lang_string('managerrut', 'local_mutualreport'));
    ...
    public function output_with_external(): string {
        ...
        /** @var \local_mutualreport\output\externalreportbuilder_renderer $renderer */
        $renderer = $PAGE->get_renderer('local_mutualreport', 'externalreportbuilder');
        $report = new \local_mutualreport\output\eabc_system_report(
    ...
    public function get_output_class(): string {
        return \local_mutualreport\output\eabc_system_report::class;
    }
