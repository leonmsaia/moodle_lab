...
/**
 * Company RUT list filter class implementation for Moodle 3.5 external DB.
 *
 * @package     local_mutualreport
 * @copyright   2024 e-abclearning.com
 * @license     http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class company_rut_list35 extends base {
    ...
    public function get_sql_filter(array $values): array {
        ...
        [$rutselect, $rutparams] = $utils->db->get_in_or_equal($ruts, SQL_PARAMS_NAMED, database::generate_param_name('rut'));
