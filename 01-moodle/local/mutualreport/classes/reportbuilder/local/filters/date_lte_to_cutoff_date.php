 ...
 */
class date_lte_to_cutoff_date extends core_date {
    ...
    public function setup_form(MoodleQuickForm $mform): void {
        ...
        // For 3.5 report, only allow dates before the cutoff date.
        $dateoptions = ['optional' => true];
        $dateoptions['startyear'] = $year - 24;
        $dateoptions['stopyear'] = $year;
        ...
        $mform->addElement(
            ...
            '',
            get_string('filter_date_cutoff_info_35', 'local_mutualreport', $messagedata)
        );
