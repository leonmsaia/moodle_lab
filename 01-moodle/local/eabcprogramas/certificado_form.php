...
class certificado_form extends moodleform
{
    public function definition()
    {
        ...
        if ($action == 'crear') {
            ...
            $mform->addElement('header', 'certificado', get_string('certificado', 'local_eabcprogramas'));
        ...
        if ($id > 0) {
            ...
            if ($action == 'inactivar') {
                echo '
                <div class="alert alert-info">
                    <strong>Alerta!</strong> Inactivar modelo de certificado.
                </div>';
            ...
            if ($action == 'eliminar') {
                echo '
                <div class="alert alert-info">
                    <strong>Alerta!</strong> Eliminar modelo de certificado.
                </div>';
