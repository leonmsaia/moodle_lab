...
$string['formatnocorrect'] = 'The information sent does not have a correct format';
$string['response'] = '
...
$string['user_already_enrolment'] = '<?xml version="1.0" encoding="UTF-8"?>
	...
	<S:Body>
            ...
            <return>
                <respuesta>
                    <codigo>10</codigo>
                    <mensaje>Student already has the active course and with state</mensaje>
                    <idInscripcion>0</idInscripcion>
                </respuesta>
            </return>
	</ns0:solicitudInscripcionResponse>
...
$string['days_enrol'] = 'Days enrol';
$string['days_enrol_desc'] = 'Days to pass enrol';

$string['task_end_training'] = 'Finalize elearning training';
$string['clean_table_log'] = 'Delete log table ending cron';

$string['mark_reaggregate'] = 'Mark reaggregate completion';
...
$string['clear_local_cron'] = 'Clean up local cron logs';
