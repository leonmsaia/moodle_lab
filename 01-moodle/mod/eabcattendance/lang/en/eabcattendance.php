...
/**
 * Strings for component 'eabcattendance', language 'en'
 *
...
$string['eabcattendance:addinstance'] = 'Add a new eabcattendance activity';
$string['eabcattendance:canbelisted'] = 'Appears in the roster';
$string['eabcattendance:changeeabcattendances'] = 'Changing eabcattendances';
$string['eabcattendance:changepreferences'] = 'Changing Preferences';
$string['eabcattendance:changepreferenceseabc'] = 'Changing Preferences e-ABC';
$string['eabcattendance:export'] = 'Export Reports';
$string['eabcattendance:exporteabc'] = 'Export Reports e-ABC';
$string['eabcattendance:manageeabcattendances'] = 'Manage eabcattendances';
$string['eabcattendance:manageeabcattendanceseabc'] = 'Manage eabcattendances e-ABCc';
$string['eabcattendance:addusereabcattendanceseabc'] = 'Add users e-ABC';
$string['eabcattendance:managetemporaryusers'] = 'Manage temporary users';
$string['eabcattendance:takeeabcattendances'] = 'Taking eabcattendances';
$string['eabcattendance:view'] = 'Viewing eabcattendances';
$string['eabcattendance:viewreports'] = 'Viewing Reports';
$string['eabcattendance:viewreportsabsenteeeabc'] = 'Viewing Reports absentismo';
$string['eabcattendance:viewsummaryreports'] = 'View course summary reports';
$string['eabcattendance:warningemails'] = 'Can be subscribed to emails with absentee users';
$string['eabcattendance_already_submitted'] = 'Your eabcattendance has already been set.';
$string['eabcattendancedata'] = 'eabcattendance data';
$string['eabcattendanceforthecourse'] = 'eabcattendance for the course';
$string['eabcattendancegrade'] = 'eabcattendance grade';
$string['eabcattendancenotset'] = 'You must set your eabcattendance';
$string['eabcattendancenotstarted'] = 'eabcattendance has not started yet for this course';
$string['eabcattendancepercent'] = 'eabcattendance percent';
$string['eabcattendancereport'] = 'eabcattendance report';
$string['eabcattendanceslogged'] = 'eabcattendances logged';
$string['eabcattendancestaken'] = 'eabcattendances taken';
$string['eabcattendancesuccess'] = 'eabcattendance has been successfully taken';
$string['eabcattendanceupdated'] = 'eabcattendance successfully updated';
...
$string['attrecords'] = 'eabcattendances records';
...
If "Set unmarked at end of session" any students who have not marked their eabcattendance will be set to the unmarked status selected.';
$string['automarktask'] = 'Check for eabcattendance sessions that require auto marking';
$string['autorecorded'] = 'system auto recorded';
$string['averageeabcattendance'] = 'Average eabcattendance';
$string['averageeabcattendancegraded'] = 'Average eabcattendance';
...
$string['cannottakeforgroup'] = 'You can\'t take eabcattendance for group "{$a}"';
...
$string['changeeabcattendance'] = 'Change eabcattendance';
...
$string['confirmdeleteuser'] = 'Are you sure you want to delete user \'{$a->fullname}\' ({$a->email})?<br/>All of their eabcattendance records will be permanently deleted.';
$string['copyfrom'] = 'Copy eabcattendance data from';
...
The sessions begin on the date of the base session and continue until the \'repeat until\' date.
  ...
  * <strong>Repeat until</strong>: Select the last day of class (the last day you want to take eabcattendance).
';
...
$string['createuser'] = 'Create my new account';
...
$string['defaultsettings'] = 'Default eabcattendance settings';
$string['defaultsettings_help'] = 'These settings define the defaults for all new eabcattendances';
$string['defaultstatus'] = 'Default status set';
$string['defaultsubnet'] = 'Default network address';
$string['defaultsubnet_help'] = 'eabcattendance recording may be restricted to particular subnets by specifying a comma-separated list of partial or full IP addresses. This is the default value used when creating new sessions.';
...
$string['deletelogs'] = 'Delete eabcattendance data';
...
Your eabcattendance in %coursename% %eabcattendancename% has dropped below %warningpercent% and is currently %percent% - we hope you are ok!

To get the most out of this course you should improve your eabcattendance, please get in touch if you require any further support.';
...
$string['emailsubject_default'] = 'eabcattendance warning';
...
$string['enablecalendar_desc'] = 'If enabled, a calendar event will be created for each eabcattendance session. After changing this setting you should run the reset calendar report.';
$string['enablewarnings'] = 'Enable warnings';
$string['enablewarnings_desc'] = 'This allows a warning set to be defined for an eabcattendance and email notifications to users when eabcattendance drops below the configured threshold. <br/><strong>WARNING: This is a new feature and has not been tested extensively. Please use at your own-risk and provide feeback in the moodle forums if you find it works well.</strong>';
...
$string['enrolluser'] = 'Enroll to course';
$string['error:coursenotfound'] = 'A course with the short name {$a} can not be found.';
$string['errorenroll'] = 'Error at enroll';
$string['error:coursehasnoeabcattendance'] = 'The course with the short name {$a} has no eabcattendance activities.';
...
$string['error:qrcode'] = 'Allow students to record own eabcattendance must be enabled to use QR code! Skipping.';
...
$string['errorsingup'] = 'Error at register new user';
$string['eventdurationupdated'] = 'Session duration updated';
$string['eventreportviewed'] = 'eabcattendance report viewed';
...
$string['eventsessionipshared'] = 'eabcattendance self-marking IP conflict';
$string['eventsessionupdated'] = 'Inscripción en progreso';
$string['eventstatusadded'] = 'Status added';
$string['eventstatusupdated'] = 'Status updated';
$string['eventtaken'] = 'eabcattendance taken';
$string['eventtakenbystudent'] = 'eabcattendance taken by student';
$string['export'] = 'Export';
$string['extrarestrictions'] = 'Extra restrictions';
$string['from'] = 'from:';
$string['finduser'] = 'Find user';
$string['gradebookexplanation'] = 'Grade in gradebook';
$string['gradebookexplanation_help'] = 'The eabcattendance module displays your current eabcattendance grade based on the number of points you have earned to date and the number of points that could have been earned to date; it does not include class periods in the future. In the gradebook, your eabcattendance grade is based on your current eabcattendance percentage and the number of points that can be earned over the entire duration of the course, including future class periods. As such, your eabcattendance grades displayed in the eabcattendance module and in the gradebook may not be the same number of points but they are the same percentage.

For example, if you have earned 8 of 10 points to date (80% eabcattendance) and eabcattendance for the entire course is worth 50 points, the eabcattendance module will display 8/10 and the gradebook will display 40/50. You have not yet earned 40 points but 40 is the equivalent point value to your current eabcattendance percentage of 80%. The point value you have earned in the eabcattendance module can never decrease, as it is based only on eabcattendance to date; however, the eabcattendance point value shown in the gradebook may increase or decrease depending on your future eabcattendance, as it is based on eabcattendance for the entire course.';
...
$string['incorrectpassword'] = 'You have entered an incorrect password and your eabcattendance has not been recorded, please enter the correct password.';
$string['incorrectpasswordshort'] = 'Incorrect password, eabcattendance not recorded.';
$string['incourse'] = 'User is in course';
...
$string['modulename'] = 'Attendance e-ABC';
$string['modulename_help'] = 'The eabcattendance activity module enables a teacher to take eabcattendance during class and students to view their own eabcattendance record.

The teacher can create multiple sessions and can mark the eabcattendance status as "Present", "Absent", "Late", or "Excused" or modify the statuses to suit their needs.

Reports are available for the entire class or individual students.';
$string['modulenameplural'] = 'Attendance e-ABC';
$string['months'] = 'Months';
$string['moreeabcattendance'] = 'eabcattendance has been successfully taken for this page';
...
$string['noeabcattendanceusers'] = 'It is not possible to export any data as there are no students enrolled in the course.';
$string['noautomark'] = 'Disabled';
$string['noattforuser'] = 'No eabcattendance records exist for the user';
...
$string['noguest'] = 'Guest can\'t see eabcattendance';
...
$string['warningdesc'] = 'These warnings will be automatically added to any new eabcattendance activities. If more than one warning is triggered at exactly the same time, only the warning with the lower warning threshold will be sent.';
...
$string['notfound'] = 'eabcattendance activity not found in this course!';
$string['notmember'] = 'not&nbsp;member';
$string['noupgradefromthisversion'] = 'The eabcattendance module cannot upgrade from the version of attforblock you have installed. - please delete attforblock or upgrade it to the latest version before isntalling the new eabcattendance module';
...
$string['oversessionstaken_help'] = 'Shows statistics for sessions where eabcattendance has been taken:
    <ul>
...
$string['passwordgrp_help'] = 'If set students will be required to enter this password before they can set their own eabcattendance status for the session. If empty, no password is required.';
$string['passwordrequired'] = 'You must enter the session password before you can submit your eabcattendance';
...
$string['pluginadministration'] = 'eabcattendance administration';
$string['pluginname'] = 'Attendance e-ABC';
$string['points'] = 'Points';
$string['pointsallsessions'] = 'Points over all sessions';
$string['pointssessionscompleted'] = 'Points over taken sessions';
$string['preferences_desc'] = 'Changes to status sets will affect existing eabcattendance sessions and may affect grading.';
$string['preventsharedip'] = 'Prevent students sharing IP address';
$string['preventsharedip_help'] = 'Prevent students from using the same device (identified using IP address) to take eabcattendance for other students.';
$string['preventsharediptime'] = 'Time to allow re-use of IP address (minutes)';
$string['preventsharediptime_help'] = 'Allow an IP address to be re-used for taking eabcattendance in this session after this time has elapsed.';
$string['preventsharederror'] = 'Self-marking has been disabled for a session because this device appears to have been used to record eabcattendance for another student.';
...
$string['requiredentries'] = '  Temporary records overwrite participant eabcattendance records';
$string['requiredentry'] = '  Temporary user merge help guide';
$string['requiredentry_help'] = '<p align="center"><b>eabcattendance</b></p>
...
<tr>
<td>eabcattendance data</td>
<td>eabcattendance data</td>
<td>Temporary user will override Moodle user</td>
</tr>
<tr>
<td>No eabcattendance data</td>
<td>eabcattendance data</td>
<td>Temporary user eabcattendance will be transfered to Moodle user</td>
</tr>
<tr>
<td>eabcattendance data</td>
<td>No eabcattendance data</td>
...
$string['requiresubnet_help'] = 'eabcattendance recording may be restricted to particular subnets by specifying a comma-separated list of partial or full IP addresses.';
...
$string['resetdescription'] = 'Remember that deleting eabcattendance data will erase information from database. You can just hide older sessions having changed start date of course!';
...
$string['save'] = 'Save eabcattendance';
$string['search'] = 'Search';
$string['search:activity'] = 'eabcattendance - activity information';
$string['searchuser'] = 'Search a user';
$string['selectcountry'] = 'Select a country';
...
$string['sessionduplicate'] = 'A duplicate session exists for course: {$a->course} in eabcattendance: {$a->activity}';
...
$string['setunmarked_help'] = 'If enabled in the session, set this status if a student has not marked their own eabcattendance.';
...
$string['showsessiondescriptiononreport_desc'] = 'Show the session description in the eabcattendance report listing.';
...
$string['studentavailability_help'] = 'When students are marking their own eabcattendance, the number of minutes after session starts that this status is available.
...
$string['studentscanmark'] = 'Allow students to record own eabcattendance';
$string['studentscanmark_desc'] = 'If checked, teachers will be able to allow students to mark their own eabcattendance.';
$string['studentscanmark_help'] = 'If checked students will be able to change their own eabcattendance status for the session.';
$string['studentscanmarksessiontime'] = 'Students record eabcattendance during session time';
$string['studentscanmarksessiontime_desc'] = 'If checked students can only record their eabcattendance during the session.';
$string['studentscanmarksessiontimeend'] = 'Session end (minutes)';
$string['studentscanmarksessiontimeend_desc'] = 'If the session does not have an end time, how many minutes should the session be available for students to record their eabcattendance.';
$string['submiteabcattendance'] = 'Submit eabcattendance';
$string['subnet'] = 'Subnet';
$string['subnetactivitylevel'] = 'Allow subnet config at activity level';
$string['subnetactivitylevel_desc'] = 'If enabled, teachers can override the default subnet at the activity level when creating an eabcattendance. Otherwise the site default will be used when creating a session.';
$string['subnetwrong'] = 'eabcattendance can only be recorded from certain locations, and this computer is not on the allowed list.';
$string['summary'] = 'Summary';
$string['surname'] = 'Surname';
$string['tablerenamefailed'] = 'Rename of old attforblock table to eabcattendance failed';
$string['tactions'] = 'Action';
$string['takeeabcattendance'] = 'Take eabcattendance';
...
$string['thirdpartyemailsubject'] = 'eabcattendance warning';
$string['thirdpartyemailtext'] = '{$a->firstname} {$a->lastname} eabcattendance within {$a->coursename} {$a->aname} is lower than {$a->warningpercent} ({$a->percent})';
...
$string['thirdpartyemails_help'] = 'List of other users who will be notified. (requires the capability mod/eabcattendance:viewreports)';
...
$string['tusername'] = 'RUT';
$string['tusernamedocu'] = 'Número documento';
$string['tusernametipo'] = 'Tipo de documento';
...
$string['useradd'] = 'Add user to course';
...
$string['warnafter_help'] = 'Warnings will only be triggered when the user has had their eabcattendance taken for at least this number of sessions.';
...
$string['eabcattendance_no_status'] = 'No valid status was available - you may be too late to record eabcattendance.';
$string['studentmarked'] = 'Your eabcattendance in this session has been recorded.';
$string['privacy:metadata:sessionid'] = 'eabcattendance session ID.';
$string['privacy:metadata:studentid'] = 'ID of student having eabcattendance recorded.';
$string['privacy:metadata:statusid'] = 'ID of student\'s eabcattendance status.';
$string['privacy:metadata:statusset'] = 'Status set to which status ID belongs.';
$string['privacy:metadata:timetaken'] = 'Timestamp of when eabcattendance was taken for the student.';
$string['privacy:metadata:takenby'] = 'User ID of the user who took eabcattendance for the student.';
$string['privacy:metadata:remarks'] = 'Comments about the user\'s eabcattendance.';
$string['privacy:metadata:ipaddress'] = 'IP address eabcattendance was marked from.';
...
$string['privacy:metadata:lasttaken'] = 'Timestamp of when session eabcattendance was last taken.';
$string['privacy:metadata:lasttakenby'] = 'User ID of the last user to take eabcattendance in this session';
$string['privacy:metadata:timemodified'] = 'Timestamp of when session was last modified';
$string['privacy:metadata:notifyid'] = 'ID of eabcattendance session warning is associated with.';
...
$string['privacy:metadata:eabcattendancelog'] = 'Log of user eabcattendances recorded.';
$string['privacy:metadata:eabcattendancesessions'] = 'Sessions to which eabcattendance will be recorded.';
$string['privacy:metadata:eabcattendancewarningdone'] = 'Log of warnings sent to users over their eabcattendance record.';
...
$string["validaterutcompany"] = "The company's rut must have a correct format xxxxxxx-y or xxxxxxxx-y";
$string["validaterutuser"] = "The user's rut must have a correct format xxxxxxx-y or xxxxxxxx-y";
$string["rolwscreateactivity"] = 'Role for ws create activity';
$string["validatevericatorcode"] = 'Error, the verification code does not correspond to the document';

$string['invalidrut'] = 'Invalid rut';
$string['invalidrutparticipante'] = 'Invalid rut participante';
$string['invalidrutempresa'] = 'Invalid rut empresa';
$string['invalidemail'] = 'Invalid E-mail';
$string['invalidname'] = 'Invalid name';
$string['invalidsurname'] = 'Invalid surname';
$string['backpage'] = 'Go Back';
$string['backerror'] = 'Error at send user data to backend';
$string['backregistererror'] = 'Error at register user in backend';
$string['invalidgroup'] = 'Invalid group';

$string['apellidopaterno'] = 'Last name';
$string['uploadsupportattendance'] = 'Upload support attendance.';

$string['downloadnomina'] = 'Descargar nomina';
$string['downloadnominaexcel'] = 'Descargar nomina excel';
$string['downloadnominapdf'] = 'Descargar nomina pdf';
$string['importexcel'] = 'Importar participantes a la sesión';
$string['genger'] = 'Genger';
$string['birthdate'] = 'Birth Date';
$string['adherentename'] = 'Nombre Adherente';
$string['adherentenumber'] = 'N° Adherente';
$string['adherenterut'] = 'Rut Adherente';
$string['firma'] = 'Firma';
$string['hora'] = 'Hora';

$string['sessionsflags'] = 'Flags sesion';

$string['checkmail'] = 'Send email';
$string['checkcall'] = 'Made call';
$string['checkmail_help'] = 'Marque esta opción cuando haya enviado el email a la empresa';
$string['checkcall_help'] = 'Marque esta opción cuando haya realizado la llamada a la empresa';

$string['eabcattendance:editclose'] = 'Permite editar asistencia y notas de un curso cerrado (Finalizado)';
$string['finalizado'] = 'Curso finalizado. Debe tener permisos para habilitar edición de un curso finalizado';
$string['notnull'] = 'Campo obligatorio.';
$string['urlsminarioweb'] = 'Link a la videoconferencia';
$string['eabcattendance:receivetasknotifications'] = 'Permite recibir notificaciones de inscripciones masiva';

$string['messageprovider:message'] = 'Notificaciones asistencia';