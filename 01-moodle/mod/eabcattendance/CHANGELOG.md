...
- New Feature: Warn users when eabcattendance drops below threshold.
...
- Bug fix: Restored eabcattendances do not create calendar events correctly.

### Date:		2017-May-23
### Release:	2017052301

- New Feature: New site Level/course category report with average course eabcattendance.
...
- New Feature: Allow subnet mask to be set at the eabcattendance session level.
- New Feature: Allow certain statuses to be hidden from students when self-marking eabcattendance.
...
- Improvement: #258 Add link to eabcattendance on student overview report.
