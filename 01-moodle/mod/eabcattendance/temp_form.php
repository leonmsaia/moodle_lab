...
class temp_form extends moodleform {
    ...
    public function definition() {
        ...
        $mform->addElement('header', 'attheader', get_string('tempaddform', 'eabcattendance'));
        ...
        $mform->addElement('submit', 'submitbutton', get_string('adduser', 'eabcattendance'));
    ...
    public function validation($data, $files) {
        ...
        if ($err = mod_eabcattendance_structure::check_existing_email($data['temail'])) {
            $errors['temail'] = $err;
        }
