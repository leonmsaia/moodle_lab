@mod @mod_eabcattendance
Feature: Admin can set default status set for use in new eabcattendance
  ...
  @javascript
  Scenario: Modified default status set added to new eabcattendance
