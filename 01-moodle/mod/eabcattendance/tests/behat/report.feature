...
Feature: Visiting reports
  ...
  Background:
    ...
    And the following config values are set as admin:
      | enablewarnings | 1 | eabcattendance |
  ...
  Scenario: Teacher takes eabcattendance
    ...
    Then I click on "Take eabcattendance" "link" in the "1AM - 2AM" "table_row"
    # Late
  ...
  Scenario: Teacher changes the maximum points in the eabcattendance settings
    Given I log in as "teacher1"
    And I am on "Course 1" course homepage
    And I follow "Attendance"
    And I navigate to "Edit settings" in current page administration
  ...
  Scenario: Teacher take eabcattendance of group session
    ...
    When I click on "Take eabcattendance" "link" in the "3AM - 4AM" "table_row"
    # Present
  ...
  Scenario: Teacher visit summary report and absentee report
    ...
    When I click on "Take eabcattendance" "link" in the "1AM - 2AM" "table_row"
    # Late
    And I click on "td.cell.c4 input" "css_element" in the "Student 1" "table_row"
    And I press "Save eabcattendance"
