@mod @mod_eabcattendance @javascript
Feature: Test the various new features in the eabcattendance module
  ...
  Scenario: A teacher can take eabcattendance for temporary users
    Given I log in as "teacher1"
    And I am on "Course 1" course homepage
    And I follow "Test eabcattendance"
    And I follow "Temporary users"
    ...
    And I follow "Take eabcattendance"
    # Present
    ...
    And I press "Save eabcattendance"
    And I follow "Report"
    ...
    # Merge user.
    When I follow "Test eabcattendance"
    And I follow "Temporary users"
  ...
  Scenario: A teacher can create and use multiple status lists
    ...
    When I click on "Take eabcattendance" "link" in the "10AM" "table_row"
    ...
    And I click on "Take eabcattendance" "link" in the "12PM" "table_row"
  ...
  Scenario: A teacher can use the radio buttons to set eabcattendance values for all users
    Given I log in as "teacher1"
    And I am on "Course 1" course homepage
    And I follow "Test eabcattendance"
    And I follow "Add"
    And I set the following fields to these values:
      | id_addmultiply | 0 |
    And I click on "submitbutton" "button"
    And I click on "Take eabcattendance" "link"
